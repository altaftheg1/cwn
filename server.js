...
<div style="max-width:600px;margin:0 auto;">
  <div style="background:#C8102E;border-radius:12px 12px 0 0;padding:22px 24px;text-align:center;">
    <div style="color:white;font-size:22px;font-weight:900;letter-spacing:2px;font-family:Georgia,serif;">DUB</div>
    <p style="color:rgba(255,255,255,0.8);font-size:12px;margin:4px 0 0;">DUB</p>
  </div>
  ...
  <div style="background:white;border-top:1px solid #E8E4DF;padding:20px 24px;text-align:center;">
    <a href="${APP_BASE_URL}" style="display:inline-block;background:#C8102E;color:white;text-decoration:none;padding:12px 28px;border-radius:6px;font-weight:700;font-size:14px;">Read all stories on DUB &rarr;</a>
  </div>
...
cron.schedule("0 5 * * 5", async () => {
  ...
  await sendDigestToSubscribers({
    ...
    subject:  "DUB Weekly Summary — Top Stories This Week",
...
<html><body style="font-family:Georgia,serif;max-width:600px;margin:0 auto;background:#F7F4EF;padding:40px 20px;">
  <div style="text-align:center;margin-bottom:32px;">
    <div style="background:#C8102E;color:white;display:inline-block;padding:12px 24px;font-size:24px;font-weight:900;letter-spacing:2px;">DUB</div>
    <p style="color:#666;font-size:13px;margin-top:8px;">DUB</p>
  </div>
...
<html><body style="font-family:Georgia,serif;max-width:600px;margin:0 auto;background:#F7F4EF;padding:40px 20px;text-align:center;">
  <div style="margin-bottom:24px;">
    <div style="background:#C8102E;color:white;display:inline-block;padding:10px 22px;font-size:22px;font-weight:900;letter-spacing:2px;">DUB</div>
  </div>
  <h1 style="font-size:24px;color:#1A1208;">You've been unsubscribed</h1>
  <p style="color:#666;margin:16px 0 28px;">You won't receive any more emails from DUB.</p>
  ...
  const text = `You've been unsubscribed from DUB.

You won't receive any more emails.

Changed your mind? Visit: ${resubUrl}`;
  await sendResendEmail({ to: email, subject: "You've been unsubscribed from DUB", html, text });
}
